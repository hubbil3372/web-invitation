<div class="col-md-6 d-flex justify-content-center">
  <div class="align-self-center w-100">
    <div class="text-center mb-5 mt-5">
      ...
      <p class="font-color-page text-uppercase">Aplikasi Manajemen Undangan</p>
    </div>
    <div class="row justify-content-center">
      <div class="col-10 col-sm-8 col-md-10 col-lg-7">
        <div class="card card-body py-5 px-1">
          ...
          <div class="col-md-12">
            <div class="d-grid gap-2 mt-5">
              ...
              <a class="text-decoration-none text-muted" href="<?= site_url('lupa-password') ?>">Lupa Password?</a>
            </div>
            <?= form_close() ?>
          </div>
        </div>
      ...
      <div class="row my-5">
        <div class="col-12 pb-5 pb-md-0">
          <p class="text-center mb-1 font-color-page fw-bold">&copy; <?= date('Y') ?> Manajemen Undangan</p>
          <p class="text-center mb-1 font-color-page">Developed by Noname</p>
        </div>
      </div>
    </div>
  </div>